...
export default function RegistrationForm() {
    ...
    const validationSchema = Yup.object({
        ...
        confirmPassword: Yup.string().oneOf([Yup.ref('password'), ''], 'Passwords must match').required('Required Field'),
        modeOfContact: Yup.string().required('Required Field'),
            ...
            {formik => {
                return (
                    <Form>
                        ...
                        label='Mode Of Contact' name='modeOfContact' options={modeOptions} />
